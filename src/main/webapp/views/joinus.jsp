...
<script type="text/javascript" src="http://api.map.baidu.com/api?ak=h6HG0gT9qzmHWNHPtHwy2r31RQQTzaK5&v=2.0&services=true"></script>
...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(117.102312,39.11087);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"公司",content:"天津市西青区新科道新津国际7号楼2门302",point:"117.102146|39.110996",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    //创建marker
    function addMarker(){
