  ...
  <div class="navbar-inner">
    <div class="container-fluid">
      ...
      <div style="float:left;display:block;">
		<form id="form">
			<select name="code" value="${detail.code}" style="height:30px;">
      ...
      <div class="nav-collapse collapse">
          ...
          <li>
            ...
            <div class="btn-group">
              <button type="button" href="#clear" id="clear" class="btn btn-primary" ><i class="icon-chevron-down icon-white"></i>清空</button>
              <button class="btn btn-primary" data-target="#downloadModal" rel="/build/downloadModal" role="button" data-toggle="modal"><i class="icon-trash icon-white"></i>提交</button>
            </div>
          </li>
        </ul>
      </div>
