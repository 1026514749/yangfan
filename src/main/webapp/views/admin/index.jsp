...
<img alt="" src="${path}/img/avatar1_small.jpg">
<span class="username">admin</span>
<b class="caret"></b>
</a>
<ul class="dropdown-menu extended logout">
<li class="log-arrow-up"></li>
<li><a href="javascript:" onclick="loginOut()"><i class="fa fa-key"></i>注   销</a></li>
</ul>
</li>
...
<span>基本信息</span>
<span class="label label-primary span-sidebar">1</span>
</a>
<ul class="sub">
...
<i class="fa fa-th"></i>
<span>员工管理</span>
<span class="label label-inverse span-sidebar">1</span>
</a>
<ul class="sub">
...
2009-2016 &copy; 天津市扬帆教育 by <a href="" target="_blank">SJM</a>.
<a href="#" class="go-top">
...
$(function(){
	...
	$("#rightContentFrame").css("height", height+"px");
});
</script>
